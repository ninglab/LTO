...
if __name__ == "__main__":
    ...
    #seq_len = 7
    file_path_list = [
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_1/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_2/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_3/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_4/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_5/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_6/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_7/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_8/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_9/",
    "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_10/",
    ]
    
    embedding_path_list = [
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_1/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_2/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_3/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_4/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_5/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_6/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_7/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_8/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_9/",
    "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_train_10/"

    ]
    
    groundtruth_files_list = [
    "./Data/svamp_train_1.jsonl",
    "./Data/svamp_train_2.jsonl",
    "./Data/svamp_train_3.jsonl",
    "./Data/svamp_train_4.jsonl",
    "./Data/svamp_train_5.jsonl",
    "./Data/svamp_train_6.jsonl",
    "./Data/svamp_train_7.jsonl",
    "./Data/svamp_train_8.jsonl",
    "./Data/svamp_train_9.jsonl",
    "./Data/svamp_train_10.jsonl"
    ]
    ...
    embeddings_test, labels_test = load_data_token_localization(args, "./results/OutputInfo/en/Output/allenai/OLMo-7B-0724-Instruct-hf/svamp_test_1/", "./results/OutputInfo/en/HiddenStates/allenai/OLMo-7B-0724-Instruct-hf/svamp_test_1/", load_groundtruth_answer("./Data/svamp_test_1.jsonl"))
