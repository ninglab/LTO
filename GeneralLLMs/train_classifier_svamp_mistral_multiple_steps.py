...
if __name__ == "__main__":
    ...
    #seq_len = 7
    file_path_list = [
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_1/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_2/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_3/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_4/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_5/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_6/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_7/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_8/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_9/",
    "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_10/",
    ]
    
    embedding_path_list = [
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_1/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_2/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_3/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_4/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_5/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_6/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_7/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_8/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_9/",
    "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_train_10/"
    ...
    embeddings_test, labels_test = load_data_token_localization(args, "./results/OutputInfo/en/Output/mistralai/Mistral-7B-Instruct-v0.1/svamp_test_1/", "./results/OutputInfo/en/HiddenStates/mistralai/Mistral-7B-Instruct-v0.1/svamp_test_1/", load_groundtruth_answer("./Data/svamp_test_1.jsonl"))
