...
if __name__ == "__main__":
    ...
    #embeddings_test, labels_test = load_data_token_localization(args, "./results/svamp/result_test_latent_rep.jsonl", "./results/svamp/test_latent_rep/latent_embeddings/", "./results/svamp/test_latent_rep/output_ids/")
